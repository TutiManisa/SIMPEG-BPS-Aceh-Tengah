    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
           <!-- User Info -->
                ...
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                <a href="?page=guru&action=grafik_guru"> <i class="material-icons"> insert_chart</i><span> Staff</span></a>
                            </li>
                        </ul>
                    </li>
                     <li>
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2017 <a href="nisa18317@gmail.com">Tuti Manisa | 210401012</a>.
                </div>
                <div class="version">
